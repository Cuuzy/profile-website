...
```bash
git remote add encore encore://profile-website-r2q2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/profile-website-r2q2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/profile-website-r2q2/settings/integrations/github)
